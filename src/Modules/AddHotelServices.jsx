  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-screen space-y-6 landing-page ">
      ...
      <div className="container p-4 mx-auto">
        ...
        >
          <h2 className="mb-4 text-2xl text-yellows">Add Hotel Information</h2>

          <div className="mb-4">
            <label className="block mb-2 text-yellows">Room ID</label>
            <input
              type="text"
...
export default AddHotelServices;
